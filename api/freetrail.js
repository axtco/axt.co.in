...
// --- Configuration ---
// AWS Region is read from the environment variable (e.g., ap-south-1)
const AWS_REGION = process.env.AWS_REGION;
const DYNAMODB_TABLE_NAME = process.env.DYNAMODB_TABLE_NAME;
const RESEND_API_KEY = process.env.RESEND_API_KEY;
const SENDER_EMAIL = 'updates@goaxt.cloud';

if (!AWS_REGION || !DYNAMODB_TABLE_NAME || !RESEND_API_KEY) {
    console.error("Missing environment variables. Check AWS_REGION, DYNAMODB_TABLE_NAME, and RESEND_API_KEY.");
}
